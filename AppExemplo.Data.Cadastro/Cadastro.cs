...
// 
//     Configuration file:     "AppExemplo.Data.Cadastro\App.config"
...
namespace AppExemplo.Data.Cadastro
{
    // ************************************************************************
    // Unit of work
    public interface ICadastroDbContext : IDisposable
    {
        IDbSet<__RefactorLog> __RefactorLog { get; set; } // __RefactorLog
    ...
    // ************************************************************************
    // Database context
    public class CadastroDbContext : DbContext, ICadastroDbContext
    {
        public IDbSet<__RefactorLog> __RefactorLog { get; set; } // __RefactorLog
        ...
        static CadastroDbContext()
        {
            System.Data.Entity.Database.SetInitializer<CadastroDbContext>(null);
        }
        ...
        public CadastroDbContext(string connectionString) : base(connectionString)
        {
        }

        public CadastroDbContext(string connectionString, System.Data.Entity.Infrastructure.DbCompiledModel model) : base(connectionString, model)
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new __RefactorLogConfiguration());
        ...
        {
            modelBuilder.Configurations.Add(new __RefactorLogConfiguration(schema));
    ...
    public class FakeCadastroDbContext : ICadastroDbContext
    {
        public IDbSet<__RefactorLog> __RefactorLog { get; set; }
        public IDbSet<Clientes> Clientes { get; set; }
        public IDbSet<Contas> Contas { get; set; }
        public IDbSet<Transacoes> Transacoes { get; set; }

        public FakeCadastroDbContext()
        {
            __RefactorLog = new FakeDbSet<__RefactorLog>();
    ...
    // __RefactorLog
    internal class __RefactorLogConfiguration : EntityTypeConfiguration<__RefactorLog>
    {
        public __RefactorLogConfiguration()
            : this("dbo")
        {
        }
 
        public __RefactorLogConfiguration(string schema)
        {
